/*
	...
	Usage :
	<label for='toto_1'>Try</label>
		<input type='checkbox' id='toto_1' class='crirHiddenJS' value='true' checked='checked' name='toto_1' />
	
	Explain :
		label is required and For attribut must point to input id AND name
		for the checkbox, class crirHiddenJS is required and must be unique. Values can be "true" or "false" not 1 or 0.
		The checked attribute is optionnal but must be declared as is (checked='checked').
*/
...
crir = {
	...
	init: function() {
        ...
        if(inputElement && inputElement.getAttributeNode('type') != null)
        {
