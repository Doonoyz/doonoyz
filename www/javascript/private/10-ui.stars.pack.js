...
(function($) {
    ...
    $.widget("ui.stars", {
        _init: function() {
            ...
            this.$rboxs = o.isSelect ? $("option", this.$selec) : $("input:radio", this.element);
      ...
      this.$stars.bind("click.stars", function() {
          ...
          // Si c est une modification de langue 
          if(o.newLang == false){
              // Si on annule la modification 
              if(!confirm(o.confirmMessage)){
                  // Remettre les etoiles a l origine 
                  fillTo(self.originalValue,false);
                  // On exit 
                  return false;
              }else{
                // L origine est la nouvelle valeur 
                self.originalValue=self.$stars.index(this);
              }
          }
        ...
        .bind("mouseover.stars", function() {
          $(this).parents().trigger("mouseover");
